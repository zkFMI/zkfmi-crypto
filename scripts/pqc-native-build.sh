...
set -euo pipefail
cd "$HOME/work/pqc-astra-high-20260906"
...
docker build --progress=plain --file .cache/native-build/Dockerfile \
  --tag pqc-astra-high:rust-1.97.1-mpspdz-9d809599-openssl-3.5.5-pqc-auth-v2 .cache/native-build
docker image inspect pqc-astra-high:rust-1.97.1-mpspdz-9d809599-openssl-3.5.5-pqc-auth-v2 --format 'image_id={{.Id}}'
